...
public:
    ...
    inline void blockCopy(int destu, int destd, int destl, int destr, const matrix<DType>& sour, int souru, int sourl);
...
template <typename DType>
inline void matrix<DType>::blockCopy(int destu, int destd, int destl, int destr, const matrix<DType>& sour, int souru, int sourl)
{
    for (int iterdy=destu*sizex, itersy=souru*sour.sizex; iterdy<destd*sizex; iterdy+=sizex, itersy+=sour.sizex)
    {
        for (int iterdx=destl, itersx=sourl; iterdx<destr; ++iterdx, ++itersx)
        {
            
            data[iterdy+iterdx]=sour.data[itersy+itersx];
        }
    }
}
